      ...
      <section className="flex flex-col gap-5 ">
        ...
        {data?.data.map((item, index) => (
          <div key={index} className="flex items-center justify-between text-sm  ">
            ...
            <span className="shrink-0 w-30 truncate text-center">{item.content2}</span>
            <span className="shrink-0 w-30 truncate text-center">{item.content3}</span>
            <span className="shrink-0 w-30 truncate text-center">{item.content4}</span>
          </div>
        ))}
      </section>
    </div>
